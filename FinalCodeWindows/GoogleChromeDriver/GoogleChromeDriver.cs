...
namespace GoogleChromeDriver
{
    public class Driver
    {
        ...
        public static void pause(IWebDriver driver, int seconds)
        {
        ...
        private static bool checkGoogleCookies(IWebDriver driver) //getting through google chrome cookie policy
        {

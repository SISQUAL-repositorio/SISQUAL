...
print("Done.")
print(extract_address(chunker, "Worten Arrábida Shopping Praceta Henrique Moreira 244 - Afurada | Arrábida Shopping Loja 4.57/4.61 Piso 0 4400-346 Vila Nova de Gaia Todos os dias: 10:00 - 23:00 VER MAIS"))
